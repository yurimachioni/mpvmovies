...
class AddMovieToFavorites @Inject constructor(@BackgroundScheduler executorScheduler: Scheduler,
    ...
    override fun getRawCompletable(param: String)= moviesRepositoryInterface.addMovieToFavorites(param)
